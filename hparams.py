...
class Hyperparams:
    ...
    test_data = '''/data/public/rw/datasets/VCTK-Corpus/wav48/p227/p227_363.wav|2|we are encouraged by the news.
                    /data/public/rw/datasets/VCTK-Corpus/wav48/p231/p231_430.wav|6|it was a breathtaking moment.'''
